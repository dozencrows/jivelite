...
local log                    = require("jive.utils.log").logger("applet.LCDSkin")
...
local imgpath = "applets/LCDSkin/images/"
...
function param(self)
		...
		radialClock = {
			hourTickPath     = 'applets/LCDSkin/images/Clocks/Radial/radial_ticks_hr_on.png',
			minuteTickPath   = 'applets/LCDSkin/images/Clocks/Radial/radial_ticks_min_on.png',
		},
...
function skin(self, s)
	...
	local ALBUMMENU_SMALL_FONT_SIZE = 12
	local TEXTMENU_FONT_SIZE = 15
	local POPUP_TEXT_SIZE_1 = 26
	local POPUP_TEXT_SIZE_2 = 20
	local TRACK_FONT_SIZE = 14
	local TEXTAREA_FONT_SIZE = 14
	local CENTERED_TEXTAREA_FONT_SIZE = 22

	local CM_MENU_HEIGHT = 45

	local TEXTINPUT_FONT_SIZE = 15
	local TEXTINPUT_SELECTED_FONT_SIZE = 20

	local HELP_FONT_SIZE = 14
	local UPDATE_SUBTEXT_SIZE = 15
